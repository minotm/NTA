...
print('Nucleotide Augmentation of AAV Data Set...')
#================================== Load Data  ===================================
...
aug_factor = 1
data_path = '../data/aav/'
out_file_str_test = data_path + 'aav_seven_vs_rest_test_dna.csv'
...
aug_dict = {}
aug_dict[0.005] = [1200, 60000, 120000]
aug_dict[0.01] = [1200, 60000, 120000]
aug_dict[0.05] = [6000, 60000, 120000]
aug_dict[0.1] = [12000, 60000, 120000]
aug_dict[0.25] = [30000, 60000, 300000]
aug_dict[0.5] = [60000, 120000, 300000]
aug_dict[0.75] = [100000, 200000, 300000]
aug_dict[1.0] = [100000, 200000, 300000]
...
for data_str in data_str_list:
    for key in aug_dict:
        ...
        for i in range(len(aug_dict[key])):
            ...
            outpath =  data_path
            out_file_str_train = outpath + 'aav_' + data_str + '_train_' + 'truncated_' + str(truncate_factor) + f'_dna_aug_{i+1}.csv'
            out_file_str_val = outpath + 'aav_' + data_str + '_val_' + 'truncated_' + str(truncate_factor) + f'_dna_aug_{i+1}.csv'
            ...
            if truncate_factor == 'full':
                ...
                out_file_str_train = outpath + 'aav_' + data_str + '_train_' + 'truncated_' + str(truncate_factor) + f'_dna.csv'
                out_file_str_val = outpath + 'aav_' + data_str + '_val_' + 'truncated_' + str(truncate_factor) + f'_dna.csv'
...
for data_str in data_str_list:
    for truncate_factor in truncate_factor_list:
        for final_data_len in final_data_len_list:
            ...
            outpath = data_path
            out_file_str_train = outpath + 'aav_' + data_str + '_train_' + 'truncated_' + str(truncate_factor) + f'_dna_aug_{final_data_len}.csv'
            out_file_str_val = outpath + 'aav_' + data_str + '_val_' + 'truncated_' + str(truncate_factor) + f'_dna_aug_{final_data_len}.csv'
