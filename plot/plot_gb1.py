...
path = '../results/'
cnn = 'gb1_three_vs_rest_cnn2_full.csv'
transformer = 'gb1_three_vs_rest_t2_full.csv'
...
for model in model_str_list:
    ...
    palette_dict = {'AA Baseline': aa_b, 'DNA Baseline': dna_b, 'AA Online Baseline': aa_b,
                    ...
                    'Online Codon Balance': cb[7], 'Online': cb[4], 
                    'Online DNA Baseline': dna_b, 'Online Codon Shuffle': cb[0]}
    ...
    results.legend.legendHandles = results.legend.legendHandles[1:6]
