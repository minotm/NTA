...
nt_aa_dict_codon_shuffle = {
     ...
     'H': ['CTA', 'CGA'],
     'I': ['TCC', 'GTG', 'ACA'],
     'L': ['GAT', 'CTC', 'CGG', 'GAC', 'CCG', 'CTG'],
     'K': ['AAA', 'CGT'],
     'M': ['GGT'],
     'F': ['CAA', 'CCC'],
     'P': ['TAT', 'TGG', 'TGT', 'CCA'],
     'S': ['TAA', 'GTC', 'GCG', 'AAT', 'GCA', 'TAC'],
     'T': ['TTC', 'ACT', 'AGT', 'TAG'],
     'W': ['AGA'],
     'Y': ['CTT', 'GGA'],
     'V': ['CGC', 'ACC', 'TGA', 'TTT'],
